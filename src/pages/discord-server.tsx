    ...
    <>
      ...
      >
        ...
        <div style={{paddingTop: '64px'}}>
          <h1>กฏและข้อระเบียบในการใช้ server</h1>
          <i>
            กรณีโดนแบนออกจากเซิฟเวอร์หรือโดน Warn/Mute/Ban ไม่มีการปลดนะครับ
            เตือน!
          </i>
          <div style={{ paddingTop: "24px" }}>
            <a>
              1. กรณีใช้คำสั่ง Commands กรุณาใช้คำสั่งที่ห้อง Bot-Commands
              เท่านั้น (แอดมินสามารถ Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              2. กรุณาแชทให้ถูก Channel ที่ถูกสร้างขึ้น
              เพราะอาจจะทำให้รบกวนผู้อื่น (แอดมินสามารถ Mute / Banned
              ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              3. ห้ามโปรโมท Discord หรือ กรณีเช่นว่า Spam Discord หรืออะไรเข้ามา
              (แอดมินสามารถ Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              4. ไม่สแปมแชท ไม่สแปมเสียง หรือ ทำให้รบกวนผู้อื่น (แอดมินสามารถ
              Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              5. ไม่สแปมแชทประกาศ everyone หรือ Tags User / Admin รัวๆ
              (แอดมินสามารถ Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              6. ไม่ปลอมแปลงเป็นบุคคลคนอื่นๆ (แอดมินสามารถ Mute / Banned
              ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              7. ห้าม Bully หรือ ดูถูกผู้อื่น ทุกกรณี
              ที่ทำให้ฝั่งตรงข้ามเจาะจงหรือไม่เจาะจง มีผลกระทบ (แอดมินสามารถ
              Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>
              8. ไม่ยุยงทะเลาะวิวาทภายใน Discord ทุกกรณี
              นอกจากแอดมินมันจะตีกันเอง
            </a>
            <br />
            <a>
              9. ห้ามส่งเรท 18+ หรืออื่นๆไม่เหมาะสม อาจจะทำให้ Discord Server
              บินได้ (แอดมินสามารถ Mute / Banned ได้ตลอดเวลา)
            </a>
            <br />
            <a>10. ห้ามแหกกฏ (แอดมินสามารถ Mute / Banned ได้ตลอดเวลา)</a>
            <br />
            <br />
            <i>
              Warn/Mute: ปิดแชททุกช่องใน Discord Server แห่งนี้
              ไม่สามารถพิมพ์ได้นอกจากจะโดนปลดตามเวลา หรือไม่ก็ โดนถาวร
            </i>
            <br />
            <i>
              Ban: โดนแบนถาวรไม่มีกำหนด และ ยศ Discord Server แห่งนี้ และ
              แอดมินไม่สามารถปลดได้นอกจากกรณีอื่นๆ
            </i>
          </div>
        </div>
      </div>
